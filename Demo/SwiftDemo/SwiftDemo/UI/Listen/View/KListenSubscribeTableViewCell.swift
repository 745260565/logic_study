...
//  SwiftDemo
//
//  Created by ChengHao on 2021/6/22.
//
...
class KListenSubscribeTableViewCell: UITableViewCell {
    ...
    // MARK：- 方法
    // 根据后台时间戳返回几分钟前 几小时前 几天前 或一个星期
    func updateTimeToCurrennTime(timeSamp: Double) -> String {
        // 获取当前的时间戳
        let currentTime = Date().timeIntervalSince1970
        // 时间戳为毫秒级要／1000  毫秒就不用除1000 参数带没带000
        let timeSta: TimeInterval = TimeInterval(timeSamp / 1000)
        // 时间差
